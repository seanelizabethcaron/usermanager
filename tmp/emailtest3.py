...
emailtext = '<html><head></head><body>Dear ' + requestor + ',<br><br>Your new user account request for ' + firstname + ' ' + lastname + ' has been received and is pending review.<br><br>Thank you,<br><br>User Manager Process</body></html>'
